...
function gadget:Initialize()
	...
	keyInfo = gl.CreateList(function()
		...
		-- draws text
		gl.Text("Welcome to PA! Some useful info:", dx, dy, textSize, "o")
		...
		curPos = curPos + gapSize
		gl.Text("PA has many keybinds", dx+indent, dy-curPos, textSize, "o")
		curPos = curPos + lineHeight
		...
		curPos = curPos + lineHeight
		gl.Text("Check out the Phoenix Annihilation forum on \255\200\200\255springrts.com\255\255\255\255 for a list of all keybinds", dx+indent, dy-curPos, textSize, "o")
		curPos = curPos + gapSize	
